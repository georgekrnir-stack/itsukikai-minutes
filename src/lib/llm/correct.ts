...
以下の文字起こしテキストに含まれる誤りを修正してください。

${dictSection}
## 修正ルール
- 辞書に載っている誤表記を見つけたら修正してください
- 辞書に載っていないが、文脈から明らかに誤字と判断できるものも修正してください（例: 「感ごし」→「看護師」）
- テキストの意味や内容は一切変更しないでください
- 話者の発言の意図を変えるような修正は絶対にしないでください
- 確信が持てない場合は修正しないでください
